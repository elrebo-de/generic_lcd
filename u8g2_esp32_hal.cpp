...
extern "C" uint8_t u8g2_esp32_i2c_byte_cb(u8x8_t* u8x8,
  ...
  switch (msg) {
    ...
    case U8X8_MSG_BYTE_INIT: {
      //if (u8g2_esp32_hal.bus.i2c.i2c == U8G2_ESP32_HAL_UNDEFINED ||
      //    u8g2_esp32_hal.bus.i2c.deviceName == U8G2_ESP32_HAL_UNDEFINED) {
      //  break;
      //}

#ifdef U8G2_ESP32_HAL_USE_V2_I2C_API
    // nothing to do, already done outside of the class in I2CMaster
#else
      i2c_config_t conf = {0};
    ...
    case U8X8_MSG_BYTE_END_TRANSFER: {
      ...
      ESP_ERROR_CHECK(i2c_master_transmit(u8g2_esp32_hal.bus.i2c.i2c->GetDeviceHandle(u8g2_esp32_hal.bus.i2c.deviceName), i2c_bytes_buffer,i2c_bytes_buffer_ptr - i2c_bytes_buffer,I2C_TIMEOUT_MS));
#else
      ESP_LOGD(TAG, "End I2C transfer.");
