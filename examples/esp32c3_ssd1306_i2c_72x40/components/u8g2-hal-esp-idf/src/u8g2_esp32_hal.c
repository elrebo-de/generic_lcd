...
#ifdef U8G2_ESP32_HAL_USE_V2_I2C_API
static i2c_master_bus_handle_t bus_handle_i2c = 0; // I2C handle.
static i2c_master_dev_handle_t dev_handle_i2c = 0; // I2C handle.
#else
...
void u8g2_esp32_hal_init_i2c_handles(i2c_master_bus_handle_t busHandle, i2c_master_dev_handle_t devHandle) {
    bus_handle_i2c = busHandle;
    dev_handle_i2c = devHandle;
}
